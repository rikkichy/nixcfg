...
argument-hint: "[focus]"
---
Review all staged, unstaged, deleted, and untracked work in this repository, including OMP resources. Read `AGENTS.md`, identify the affected hosts and shared subsystems, and load the matching project skills before judging the changes.
