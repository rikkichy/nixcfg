...
5. Exact quick/full validation commands and host selection; shared or flake changes require both hosts. Separate native build/runtime checks from cross-platform evaluation.
